  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">چندگزینه‌ای</Label>
        <Switch
        ...
        <>
          <div>
            ...
            <Input
              type="number"
              min="1"
              value={question.minSelectableChoices || 1}
              onChange={(e) =>
                onUpdateField("minSelectableChoices", parseInt(e.target.value))
              }
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="number"
              min="1"
              value={question.maxSelectableChoices || 1}
              onChange={(e) =>
                onUpdateField("maxSelectableChoices", parseInt(e.target.value))
              }
            />
          </div>
        </>
